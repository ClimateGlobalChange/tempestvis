...
ifndef TEMPESTVISDIR
  $(error TEMPESTVISDIR is not defined)
endif

# Add the source directories to the include path
CXXFLAGS+= -I$(TEMPESTVISDIR)/src/base

ifeq ($(NETCDF),TRUE)
  CXXFLAGS+= -I$(TEMPESTVISDIR)/src/netcdf-cxx-4.2
  LDFLAGS+= -L$(TEMPESTVISDIR)/src/netcdf-cxx-4.2
endif
